...
THREE.OutlineEffect = function( renderer, parameters ) {
    ...
    let defaultThickness = parameters.defaultThickness !== undefined ? parameters.defaultThickness : 0.003;
    let defaultColor = parameters.defaultColor !== undefined ? parameters.defaultColor : new THREE.Color( 0x000000 );
    let defaultAlpha = parameters.defaultAlpha !== undefined ? parameters.defaultAlpha : 1.0;
    let defaultKeepAlive = parameters.defaultKeepAlive !== undefined ? parameters.defaultKeepAlive : false;
    ...
    function createMaterial( originalMaterial ) {
        ...
        let shaderID = shaderIDs[originalMaterial.type];
        ...
        let uniforms = Object.assign( {}, originalUniforms, uniformsChunk );
        ...
        let vertexShader = originalVertexShader
					...
					// remove any directionalLight related lines
    ...
    function getOutlineMaterial( originalMaterial ) {
        ...
        let outlineMaterial = getOutlineMaterialFromCache( originalMaterial );
    ...
    function onBeforeRender( renderer, scene, camera, geometry, material, group ) {
        ...
        let originalMaterial = originalMaterials[material.uuid];
    ...
    this.render = function( scene, camera, renderTarget, forceClear ) {
        ...
        let currentAutoClear = renderer.autoClear;
        ...
        let currentShadowMapEnabled = renderer.shadowMap.enabled;
...
module.exports = THREE.OutlineEffect;